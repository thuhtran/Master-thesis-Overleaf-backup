...
In this Chapter, the empirical results are discussed at length. The empirical study begins with the essential data preparation steps. In the following part, the Chapter presents the detailed descriptive statistics. The results for each research objectives i.e., market microstructure and forecasting, are then reviewed and explained.
